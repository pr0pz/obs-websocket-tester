# AI Prompt
Before coding I tried to generate the code via ChatGPT. I tried about 1.5 hours by defining and improving the prompt based on the code generated by ChatGPT after every try. At the end, I didn't get the perfect code, but the basic functionality of the first version is about 90% written by chatgpt. This file is just for archive purposes as I find it interesting.
...
- Later, when the user choses a requestType from the dropdown, I want the "description" to be shown right below the dropdown, so the user knows what he's using.
